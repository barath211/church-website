  ...
  return (
    <div>
      <div className="">
        ...
        {String(adminAccountDetail?.Email) == "bethelicrmcoimbatore@gmail.com" ? (
          <div className="">
      ...
      <div className="flex justify-end mb-5">
        <div className="bg-gray-100 p-2 rounded border border-gray-300">
          <div className="flex">
            ...
            <div className="text-lg font-bold">{churchMembers.length}</div>
          </div>
        </div>
      </div>
      <div className="overflow-x-auto">
          ...
          <tbody className="divide-y divide-gray-200">
            {churchMembers?.map((member, index) => (
              <tr key={member.id} className="divide-x divide-gray-200">
                ...
                <td className="py-2 px-4 whitespace-normal break-words">{member?._id}</td>
                ...
                <td className="py-2 px-4 whitespace-normal break-words">
                  <button onClick={() => handleDeletes(member?._id)} className="text-red-600 hover:text-red-800">
                    <FaTrashAlt />
                  </button>
                </td>
              </tr>
       ...
       {/* find user */}
                {selected === "FindUser" && <div> <div className="p-4">
      <div className="flex justify-end mb-4">
        <input
          type="text"
        ...
        />
        <button onClick={()=> finduserengine()}>Find User</button>
      </div>
      <div className="overflow-x-auto">
        <table className="min-w-full bg-white">
          <thead>
          ...
          <tbody>
              <tr key={findUserUI._id}>
                <td className="py-2 px-4 border-b border-gray-200 border-l whitespace-normal break-words">{findUserUI?.UserName}</td>
                <td className="py-2 px-4 border-b border-gray-200 border-l whitespace-normal break-words">{findUserUI?._id}</td>
                <td className="py-2 px-4 border-b border-gray-200 border-l whitespace-normal break-words">{findUserUI?.Email}</td>
                ...
                <td className="py-2 px-4 border-b border-gray-200 border-l whitespace-normal break-words">
                  <img src={findUserUI?.ProfilePicture} alt="Profile" className="w-10 h-10 rounded-full" />
                </td>
                <td className="py-2 px-4 border-b border-gray-200 border-l whitespace-normal break-words">{findUserUI?.Mobile}</td>
                <td className="py-2 px-4 border-b border-gray-200 border-l whitespace-normal break-words">{String(findUserUI?.Baptism)}</td>
                <td className="py-2 px-4 border-b border-gray-200 border-l whitespace-normal break-words">{findUserUI?.Address}</td>
                <td className="py-2 px-4 border-b border-gray-200 border-l whitespace-normal break-words">
                  <button onClick={() => handleDeleted(findUserUI?.id)} className="text-red-600 hover:text-red-800">
                    <FaTrashAlt />
                  </button>
                </td>
              </tr>
