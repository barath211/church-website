...
const Footer = () => {
  const locationChecking = useLocation();
  const [isFooter, setIsFooter] = useState(true);

  useEffect(() => {
    if (locationChecking.pathname === "/Admin") {
      setIsFooter(false);
    } else {
      setIsFooter(true);
    }
      ...
      {isFooter && (
        <footer className="px-4 py-8 bg-gray-500 dark:text-gray-800">
          <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
            ...
            {/* Ministries and Quick Links */}
            <div className="col-span-2 md:grid md:grid-cols-2 lg:col-span-2 gap-8">
              {/* Ministries */}
          ...
          <div className="py-6 text-sm text-center dark:text-gray-600">
            <p className='text-white mb-2 text-[18px] font-bold'>Designed And Hosting By 
            <span className='text-black cursor-pointer'
  onClick={() => window.location.href = 'https://www.linkedin.com/in/barath-s-560aa1278'}
> Barath
</span>
  </p>
