...
import bgImage from '../images/churchbackimage.jpg';
const Bg1 = () => {
  return (
    ...
    <div className="relative w-full max-w-[1200px] mx-auto mt-2 overflow-hidden rounded-2xl p-4">
      <img
        src={bgImage}
      ...
      <div className="absolute inset-0 flex items-center justify-center px-4 sm:px-6 md:px-8 lg:px-12">
       <h1 className='text-white text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-center'>SOCIAL SERVICE</h1>
      </div>
    </div>
  </div>   
  )
